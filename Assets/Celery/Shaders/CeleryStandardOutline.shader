Shader "Celery/Outline/CeleryStandard"
{
	Properties
	{
		// Textures
	...
	SubShader
	{
		...
		// Extra pass to increase outline quality, if transparent
		// Pass
		// {
		// 	Name "OUTLINE_DEPTH"
		// 	CGPROGRAM
		...
		Pass
		{
			...
			CGPROGRAM
				...
				#pragma fragment frag_outline
				#pragma multi_compile_fog
				#pragma multi_compile_fwdbase addshadow//novertexlight noshadowmask nodynlightmap nodirlightmap nolightmap
